 ...
 *  Dependencies: SymbolGraph.java Graph.java BreadthFirstPaths.java com.coursera.algorithms.stdlib.StdOut.java
...
public class DegreesOfSeparation {
    public static void main(String[] args) {
        ...
        // com.coursera.algorithms.stdlib.StdOut.println("Source: " + source);
