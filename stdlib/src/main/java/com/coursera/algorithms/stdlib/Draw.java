 ...
 *  Compilation:  javac com.coursera.algorithms.stdlib.Draw.java
 *  Execution:    java com.coursera.algorithms.stdlib.Draw
 *
...
/**
 *  <i>com.coursera.algorithms.stdlib.Draw</i>. This class provides a basic capability for
...
public final class Draw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    *************************************************************************/
    ...
    /**
     * com.coursera.algorithms.stdlib.Draw a line from (x0, y0) to (x1, y1).
    ...
    /**
     * com.coursera.algorithms.stdlib.Draw one pixel at (x, y).
    ...
    /**
     * com.coursera.algorithms.stdlib.Draw a point at (x, y).
    ...
    /**
     * com.coursera.algorithms.stdlib.Draw a circle of radius r, centered on (x, y).
    ...
    /**
     * com.coursera.algorithms.stdlib.Draw filled circle of radius r, centered on (x, y).
     * @param x the x-coordinate of the center of the circle
     * @param y the y-coordinate of the center of the circle
     * @param r the radius of the circle
     * @throws RuntimeException if the radius of the circle is negative
    ...
    /**
     * com.coursera.algorithms.stdlib.Draw an ellipse with given semimajor and semiminor axes, centered on (x, y).
    ...
    /**
     * com.coursera.algorithms.stdlib.Draw an arc of radius r, centered on (x, y), from angle1 to angle2 (in degrees).
     * @param x the x-coordinate of the center of the circle
     * @param y the y-coordinate of the center of the circle
     * @param r the radius of the circle
    ...
    /**
     * com.coursera.algorithms.stdlib.Draw a square of side length 2r, centered on (x, y).
    ...
    /**
     * com.coursera.algorithms.stdlib.Draw a filled square of side length 2r, centered on (x, y).
     * @param x the x-coordinate of the center of the square
     * @param y the y-coordinate of the center of the square
     * @param r radius is half the length of any side of the square
     * @throws RuntimeException if r is negative
    ...
    /**
     * com.coursera.algorithms.stdlib.Draw a rectangle of given half width and half height, centered on (x, y).
    ...
    /**
     * com.coursera.algorithms.stdlib.Draw a filled rectangle of given half width and half height, centered on (x, y).
     * @param x the x-coordinate of the center of the rectangle
     * @param y the y-coordinate of the center of the rectangle
     * @param halfWidth is half the width of the rectangle
     * @param halfHeight is half the height of the rectangle
    ...
    /**
     * com.coursera.algorithms.stdlib.Draw a polygon with the given (x[i], y[i]) coordinates.
    ...
    /**
     * com.coursera.algorithms.stdlib.Draw a filled polygon with the given (x[i], y[i]) coordinates.
     * @param x an array of all the x-coordindates of the polygon
     * @param y an array of all the y-coordindates of the polygon
     */
    ...
    *************************************************************************/
    ...
    /**
     * com.coursera.algorithms.stdlib.Draw picture (gif, jpg, or png) centered on (x, y).
