 ...
 *  Compilation:  javac com.coursera.algorithms.stdlib.Out.java
 *  Execution:    java com.coursera.algorithms.stdlib.Out
 *
...
public class Out {
    ...
    // assume language = English, country = US for consistency with com.coursera.algorithms.stdlib.StdIn
   ...
   /**
     * Create an com.coursera.algorithms.stdlib.Out object using an OutputStream.
     */
   ...
   /**
     * Create an com.coursera.algorithms.stdlib.Out object using standard output.
     */
    public Out() { this(System.out); }

   /**
     * Create an com.coursera.algorithms.stdlib.Out object using a Socket.
     */
   ...
   /**
     * Create an com.coursera.algorithms.stdlib.Out object using a file specified by the given name.
     */
    public Out(String s) {
        try {
