 ...
 *  Compilation:  javac com.coursera.algorithms.stdlib.BinaryIn.java
 *  Execution:    java com.coursera.algorithms.stdlib.BinaryIn input output
 *  
 *  This library is for reading binary data from an input stream.
 *
 *  % java com.coursera.algorithms.stdlib.BinaryIn http://introcs.cs.princeton.edu/cover.jpg output.jpg
 *
 *************************************************************************/
 ...
 *  byte first) order.
 *  <p>
 *  The client should not intermix calls to <tt>com.coursera.algorithms.stdlib.BinaryIn</tt> with calls
 *  to <tt>com.coursera.algorithms.stdlib.In</tt>; otherwise unexpected behavior will result.
 */
