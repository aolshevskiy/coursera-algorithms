 ...
 * com.coursera.algorithms.stdlib.StdDraw3D.java
 * Hayk Martirosyan
 ******************************************************************************
 * 3D Drawing Library
 *
 * Standard com.coursera.algorithms.stdlib.Draw 3D is a Java library with the express goal of making it
 ...
 * Standard com.coursera.algorithms.stdlib.Draw 3D is a Java library with the express goal of making it
 * simple to create three-dimensional models, simulations, and games.
 * Here is a <a href = "http://introcs.cs.princeton.edu/java/stddraw3d">com.coursera.algorithms.stdlib.StdDraw3D tutorial</a>
 * and the
 * <a href = "http://introcs.cs.princeton.edu/java/stddraw3d/stddraw3d-manual.html">com.coursera.algorithms.stdlib.StdDraw3D reference manual</a>.
 */
...
/*                 while (!showedOnce) {
            ...
            //    catch (InterruptedException e) { System.out.println("Error sleeping"); }
            //}
            //com.coursera.algorithms.stdlib.StdOut.println("showed once is false, rendered once");
            showedOnce = false;
            //renderedOnce = true;
     ...
     * -------------------------------------- <br>
     * com.coursera.algorithms.stdlib.StdDraw3D.ORBIT_MODE: <br>
     ...
     * -------------------------------------- <br>
     * com.coursera.algorithms.stdlib.StdDraw3D.FPS_MODE: <br>
     ...
     * Mouse       - Look <br>
     * -------------------------------------- <br>
     * com.coursera.algorithms.stdlib.StdDraw3D.AIRPLANE_MODE: <br>
     ...
     * Mouse       - Look <br>
     * -------------------------------------- <br>
     * com.coursera.algorithms.stdlib.StdDraw3D.LOOK_MODE: <br>
     * No movement, but uses mouse to look around. <br>
     *  <br>
     * Mouse - Look <br>
     * -------------------------------------- <br>
     * com.coursera.algorithms.stdlib.StdDraw3D.FIXED_MODE: <br>
     ...
     * default field of view. com.coursera.algorithms.stdlib.In this mode, closer objects appear
     ...
     * given field of view. com.coursera.algorithms.stdlib.In this mode, closer objects appear
     ...
     * com.coursera.algorithms.stdlib.In this mode, parallel lines remain parallel after
    ...
    private static void render3D () {
        ...
        //com.coursera.algorithms.stdlib.StdOut.println("showed once = true");
    }
    /* ***************************************************************
    ...
    /**
     * com.coursera.algorithms.stdlib.Draw picture (gif, jpg, or png) centered on (x, y), rescaled to w-by-h.
     */
    ...
    /**
     * com.coursera.algorithms.stdlib.Draw picture (gif, jpg, or png) centered on (x, y), rotated
    ...
    */
    ...
    /**
    * When you create a light in com.coursera.algorithms.stdlib.StdDraw3D, it returns a Light object. Light
    ...
    */
    ...
    public static class Vector3D { 
        ...
        */
        ...
        /**
         * Draws this vector as a point from the origin to com.coursera.algorithms.stdlib.StdDraw3D.
         */
        public void draw () {
        ...
        public void drawLine (Vector3D origin) {
            ...
            com.coursera.algorithms.stdlib.StdDraw3D.line(origin.x, origin.y, origin.z, end.x, end.y, end.z);
        } 
        */
    }
