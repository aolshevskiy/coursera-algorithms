 ...
 *  Compilation:  javac com.coursera.algorithms.stdlib.BinaryStdIn.java
 *  Execution:    java com.coursera.algorithms.stdlib.BinaryStdIn < input > output
 *  
 *  Supports reading binary data from standard input.
 *
 *  % java com.coursera.algorithms.stdlib.BinaryStdIn < input.jpg > output.jpg
 ...
 *  byte first) order.
 *  <p>
 *  The client should not intermix calls to <tt>com.coursera.algorithms.stdlib.BinaryStdIn</tt> with calls
 *  to <tt>com.coursera.algorithms.stdlib.StdIn</tt> or <tt>System.in</tt>;
