 ...
 *  Dependencies: Digraph.java Queue.java Stack.java com.coursera.algorithms.stdlib.StdOut.java
...
public class DepthFirstOrder {
    ...
    // depth-first search preorder and postorder in a ExactDigraph
    public DepthFirstOrder(ExactDigraph G) {
        pre    = new int[G.V()];
        post   = new int[G.V()];
    ...
    // depth-first search preorder and postorder in an edge-weighted ExactDigraph
    ...
    // run DFS in ExactDigraph G from vertex v and compute preorder/postorder
