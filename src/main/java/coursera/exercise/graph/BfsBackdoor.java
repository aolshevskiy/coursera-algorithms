 ...
 *  Dependencies: Graph.java Queue.java Stack.java com.coursera.algorithms.stdlib.StdOut.java
...
public class BfsBackdoor {
    ...
    // single source
    public BfsBackdoor(ExactGraph G, int s) {
    ...
    // multiple sources
    public BfsBackdoor(ExactGraph G, Iterable<Integer> sources) {
        marked = new boolean[G.V()];
        distTo = new int[G.V()];
        edgeTo = new int[G.V()];
    ...
    private void bfs(ExactGraph G, int s) {
    ...
    private void bfs(ExactGraph G, Iterable<Integer> sources) {
        Queue<Integer> q = new Queue<Integer>();
        for (int s : sources) {
            marked[s] = true;
            distTo[s] = 0;
    ...
    private boolean check(ExactGraph G, int s) {
    ...
    public static void main(String[] args) {
        ...
        BfsBackdoor bfs = new BfsBackdoor(G, s);
